...
class User():
    ...
    def perform_x3dh_start(self, IKr: X25519PublicKey, SPKr: X25519PublicKey) -> X25519PublicKey:
        """
    ...
    def perform_x3dh_finish(self, IKr: X25519PublicKey, EKr: X25519PublicKey) -> None:
        """
